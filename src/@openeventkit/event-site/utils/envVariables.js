...
// Added this env variable for this theme
export const CMS_BACKEND_REPO = 'CMS_BACKEND_REPO';
...
const processEnv = {
    ...
    CMS_BACKEND_REPO: process.env.GATSBY_CMS_BACKEND_REPO,
}
...
if (typeof window === 'object') {
    ...
    window.CMS_BACKEND_REPO = processEnv[CMS_BACKEND_REPO];
}